  ...
  return (
    <View style={styles.list}>
      <View style={[GlobalStyles.rowCenter, { flex: 1 }]}>
        <Image
          source={{
            uri: `https://api.dicebear.com/7.x/micah/svg?seed=${merchantName}`,
          }}
          style={styles.profile}
        />
        <Gap horizontal={2} />
        <View style={{ flex: 1 }}>
          <Text type="medium" size="lg" numberOfLines={2} ellipsizeMode="tail">
            {merchantName}
          </Text>
          <Gap vertical={2} />
...
export default React.memo(LatestHistory);
